...
const AwaitingMerchantPage: NextPage<Record<string, never>> = () => {
  ...
  const [orderBy] =
    useState<(typeof AwaitingMerchantTableColumns)[number]>("lastUpdated");
  ...
  const tableData = useInfractionTableData(AwaitingMerchantTableColumns, data);
                  ...
                  {tableData?.map((row) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {AwaitingMerchantTableColumns.map((col) => (
