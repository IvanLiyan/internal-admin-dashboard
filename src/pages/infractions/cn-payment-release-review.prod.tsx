...
const USPaymentReleaseReviewPage: NextPage<Record<string, never>> = () => {
  ...
  const [queryState, dispatch] = useReducer(
    queryStateReducer,
    { order: "ASC", orderBy: "lastUpdated", states: ["CN_BD_REVIEW_PAYMENT"] },
    initQueryState
  );
  ...
  return (
    <PageRoot title="CN Payment Release Review">
      <Paper>
...
export default USPaymentReleaseReviewPage;
