...
export type EligibleProductInfoMaxCalculatedShippingPriceArgs = {
  countries?: InputMaybe<Array<CountryCode>>;
};


export type EligibleProductInfoMaxMerchantSetShippingPriceArgs = {
  countries?: InputMaybe<Array<CountryCode>>;
};
