...
export type GetNoticeQuery = { __typename?: 'RootQuery', dsa?: { __typename?: 'DSAHub', notice?: { __typename?: 'NoticeSchema', id: string, status: NoticeStatus, description: string, notifierName: string, notifierEmail: string, disputeDescription?: string | null, disputeReviewResponse?: string | null, products: Array<{ __typename?: 'NoticeProductSchema', status: NoticeProductStatus, product: { __typename?: 'ProductSchema', id: string, name: string, description: string, mainImage: { __typename?: 'ImageSchema', wishUrl: string } } }>, datetimeCreated: { __typename?: 'Datetime', datetime: string }, datetimeDisputed?: { __typename?: 'Datetime', datetime: string } | null, notifier?: { __typename?: 'NotifierSchema', organization: string } | null, lastClaimedUser?: { __typename?: 'UserSchema', id: string, email: string } | null, supportFiles: Array<{ __typename?: 'MerchantFileSchema', id: string, displayFilename: string, fileUrl: string }>, disputeSupportFiles?: Array<{ __typename?: 'MerchantFileSchema', id: string, displayFilename: string, fileUrl: string }> | null } | null } | null };
