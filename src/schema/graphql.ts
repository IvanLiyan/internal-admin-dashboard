...
export type GetNoticesQuery = { __typename?: 'RootQuery', dsa?: { __typename?: 'DSAHub', noticeCount: number, notices: Array<{ __typename?: 'NoticeSchema', id: string, notifierEmail: string, priority: NoticePriority, datetimeCreated: { __typename?: 'Datetime', datetime: string }, notifier?: { __typename?: 'NotifierSchema', organization: string } | null, lastClaimedUser?: { __typename?: 'UserSchema', email: string } | null }> } | null };
